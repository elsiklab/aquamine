...
public class AquaMineExperimentConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AquaMineExperimentConverter converter;
    MockItemWriter itemWriter;

    public AquaMineExperimentConverterTest(String arg) {
        super(arg);
    }
