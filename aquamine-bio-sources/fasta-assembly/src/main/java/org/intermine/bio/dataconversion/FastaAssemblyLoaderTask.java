 ...
 * @author
 */
public class FastaAssemblyLoaderTask extends BaseFastaAssemblyLoaderTask
{
    private static final Logger LOG = Logger.getLogger(FastaAssemblyLoaderTask.class);
