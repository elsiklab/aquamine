...
public class PseudogeneRefseqNotTranscribedGffConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    PseudogeneRefseqNotTranscribedGffConverter converter;
    MockItemWriter itemWriter;

    public PseudogeneRefseqNotTranscribedGffConverterTest(String arg) {
        super(arg);
    }
