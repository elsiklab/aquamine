...
public class PseudogeneRefseqGffConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    PseudogeneRefseqGffConverter converter;
    MockItemWriter itemWriter;

    public PseudogeneRefseqGffConverterTest(String arg) {
        super(arg);
    }
