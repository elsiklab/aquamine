...
public class EnsemblComparaCustomConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    EnsemblComparaCustomConverter converter;
    MockItemWriter itemWriter;

    public EnsemblComparaCustomConverterTest(String arg) {
        super(arg);
    }
